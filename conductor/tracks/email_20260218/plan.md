...
- [x] Task 1: Write tests for `format_subject(bookings_data)` in `test_email_sender.py`
...
- [x] Task 2: Implement `format_subject(bookings_data)` in `email_module/sender.py`
...
- [x] Task: Conductor - User Manual Verification 'Subject Line' (Protocol in workflow.md)

## Phase 2: HTML Card Redesign
<!-- execution: sequential -->
<!-- depends: -->

- [x] Task 1: Write tests for updated `format_booking_card()` in `test_email_html.py`
...
- [x] Task 2: Add status banner to top of card in `html_template.py`
  ...
  - Commit: `feat(email): add act-now/wait status banner to HTML card` (92c1d39)

- [x] Task 3: Restructure price hero section in `html_template.py`
  <!-- files: email_module/templates/html_template.py -->
  <!-- depends: task2 -->
  ...
  - Commit: `feat(email): restructure price hero with delta and all-time low` (92c1d39)

- [x] Task 4: Remove price history table from `html_template.py`
  <!-- files: email_module/templates/html_template.py -->
  <!-- depends: task3 -->
  ...
  - Commit: `refactor(email): remove price history table from HTML card` (92c1d39)

- [x] Task: Conductor - User Manual Verification 'HTML Card Redesign' (Protocol in workflow.md)

## Phase 3: Plain Text Update
<!-- execution: sequential -->
<!-- depends: -->

- [x] Task 1: Write tests for updated `format_email_body_text()` in `test_email_text.py`
...
- [x] Task 2: Update `format_email_body_text()` in `formatters.py`
  ...
  - Commit: `feat(email): update plain text email with status line and all-time low` (50ce009)

- [x] Task: Conductor - User Manual Verification 'Plain Text Update' (Protocol in workflow.md)
